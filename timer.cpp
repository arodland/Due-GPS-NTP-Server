...
static void timer1_setup() {
  ...
  TC0->TC_CHANNEL[1].TC_RC = 20000000;         // Period = 1 second
...
static void timer0_setup() {
  ...
  TC0->TC_CHANNEL[0].TC_RC = 20000000;                         // Period = 1 second
  TC0->TC_CHANNEL[0].TC_RB = 20000000 - ((PPS_OFFSET_NS - PPSOUT_OFFSET_NS) / 50); // Drive high at top of second
  PIO_Configure(
    PIOB,
    PIO_PERIPH_B,
    PIO_PB27B_TIOB0,
